									...
									<div class="card">
										<div class="card-body card-block">
											@if ($errors->any())
												...
												<br>
											@endif
											<form action="{{ route('profile-update', $request->id) }}" method="post" class="form-horizontal">
												@csrf
												...
												<div class="row form-group float-right">
													<div class="col">
														...
														<a href="{{ route('profile-student', $request->id) }}" class="btn btn-sm btn-danger">Batal</a>
													</div>
												</div>
											</form>
										</div>
