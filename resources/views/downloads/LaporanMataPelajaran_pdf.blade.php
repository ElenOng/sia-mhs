                ...
                <div class="col-lg-12">
                    <table id="bootstrap-data-table" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th colspan="{{ count($titles) + 1 + (2 * count($titles)) }}">Nama Siswa : {{ $student->name }}</th>
                            </tr>
                            @foreach($basic_cur as $base)
                            <tr>
                                <td>{{ $base->basic_cur }}</td>
                                @foreach($value_data as $value)
                                @if($base->basic_cur == $value->valued->basic_cur && $value->students_id == $student->id)
                                    <td>{{ $value->value }}</td>
                                    <td>{{ $value->valued->weight }}</td>
                                    <td>{{ $value->total }}</td>
                                @endif
                                @endforeach
                            </tr>
